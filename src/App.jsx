...
import { signInWithPassword, signUpWithPassword, getSession, onAuthStateChange, signOut, fetchMyProfile } from "./lib/auth";
      ...
      <Card className="w-full max-w-sm p-7">
        ...
        {signedUp ? (
          ...
          <form onSubmit={submit}>
            <p className="font-semibold text-slate-900 text-center mb-1">{mode === "signin" ? "Sign in to Wareef" : "Create your password"}</p>
            <p className="text-sm text-slate-500 text-center mb-5">
              {mode === "signin" ? "Use the email and password your coordinator set up for you." : "First time here? Set a password for the email your coordinator already registered."}
            </p>
            <input
              type="email"
              required
            ...
            <Button type="submit" className="w-full mb-3" disabled={busy}>
              {busy ? "Please wait…" : mode === "signin" ? "Sign in" : "Create password & sign up"}
            </Button>
            <button
              type="button"
            ...
            >
              {mode === "signin" ? "First time here? Set up your password" : "Already have a password? Sign in"}
            </button>
          </form>
        )}
      </Card>
